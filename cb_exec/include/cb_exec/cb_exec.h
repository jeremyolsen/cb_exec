...
public:
    ...
    void navioStateCallback(const mavros_msgs::State::ConstPtr &msg);
...
private:
    ...
    public:
        ...
        virtual void executeCommand(const CBExec& ctl, const geometry_msgs::PoseStamped& goto_pose,
    ...
    class Drone: public Vehicle
    {
        ...
        void executeCommand(const CBExec& ctl, const geometry_msgs::PoseStamped& goto_pose,
